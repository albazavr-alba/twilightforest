...
public class OminousFireCategory implements IRecipeCategory<@NotNull OminousFireRecipe> {
	public static final IRecipeType<@NotNull OminousFireRecipe> OMINOUS_FIRE = IRecipeType.create(TwilightForestMod.ID, "ominous_fire", OminousFireRecipe.class);
	...
	@Override
	public IRecipeType<@NotNull OminousFireRecipe> getRecipeType() {
		return OMINOUS_FIRE;
	}
	...
	public void draw(OminousFireRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphicsExtractor graphics, double mouseX, double mouseY) {
		...
		ItemStack fireStack = new ItemStack(TFBlocks.OMINOUS_FIRE.get().asItem());
		graphics.item(fireStack, 47, 11);
	}
