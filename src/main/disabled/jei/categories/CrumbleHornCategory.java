...
public class CrumbleHornCategory implements IRecipeCategory<@NotNull CrumbleRecipe> {
	public static final IRecipeType<@NotNull CrumbleRecipe> CRUMBLE_HORN = IRecipeType.create(TwilightForestMod.ID, "crumble_horn", CrumbleRecipe.class);
	...
	@Override
	public IRecipeType<@NotNull CrumbleRecipe> getRecipeType() {
		return CRUMBLE_HORN;
	}
