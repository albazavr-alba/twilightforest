...
public class MoonwormQueenExtension implements ICraftingCategoryExtension<@NotNull MoonwormQueenRepairRecipe> {
	@Override
	public List<SlotDisplay> getIngredients(RecipeHolder<@NotNull MoonwormQueenRepairRecipe> recipeHolder) {
		return List.of();
	}

	@Override
	public void setRecipe(RecipeHolder<@NotNull MoonwormQueenRepairRecipe> recipe, IRecipeLayoutBuilder builder, ICraftingGridHelper craftingGridHelper, IFocusGroup focuses) {
	...
	@Override
	public void onDisplayedIngredientsUpdate(RecipeHolder<@NotNull MoonwormQueenRepairRecipe> recipeHolder, List<IRecipeSlotDrawable> recipeSlots, IFocusGroup focuses) {
