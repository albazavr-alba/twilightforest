...
public class CasketRepairExtension implements ICraftingCategoryExtension<@NotNull CasketRepairRecipe> {
	@Override
	public List<SlotDisplay> getIngredients(RecipeHolder<@NotNull CasketRepairRecipe> recipeHolder) {
		return List.of();
	}

	@Override
	public void setRecipe(RecipeHolder<@NotNull CasketRepairRecipe> recipeHolder, IRecipeLayoutBuilder builder, ICraftingGridHelper craftingGridHelper, IFocusGroup focuses) {
